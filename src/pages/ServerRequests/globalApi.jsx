...
//Switchcontrollers-------------------------------------------------------------
export const RETRIEVESWITCHCONTROLLERSENDPOINT =
  HOST + "/room/retrieve-switchcontrollers";
export const CREATESWITCHCONTROLLERENDPOINT =
  HOST + "/switchcontrollers/create";
...
export const deleteGroup = async (body) => {
  const result = await fetch(RETRIEVESLOTSENDPOINT, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
      Authorization: "Bearer " + auth_token,
...
export const deleteSlot = async (body) => {
  const result = await fetch(REMOVESLOTFROMGROUPENDPOINT, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
